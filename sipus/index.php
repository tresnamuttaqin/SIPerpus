	...
	<div id="container">
		<div id="header">
			...
			<div id="nama-alamat-perpustakaan-container">
				...
				<div class="nama-alamat-perpustakaan">
					<h4>Jl. Katalia No 11, Telp: (001)345678</h4>
				</div>
			</div>
		</div>
		<div id="header2">
				...
				<div class="col-md-4 col-md-offset-4">
					<div class="panel panel-warning login-panel" style="background-color:rgba(255, 255, 255, 0.6);position:relative;">
						<div class="panel-heading">
							<h3 class="panel-title"><i class="fa fa-windows fa-fw"></i> Halo! Selamat membaca, semoga setelah dengan mengunjungi sistem kami lalu membaca buku yang telah disediakan ilmu kawan2 bertambah :) </h3>
						</div>
